...
-- ('McDonald''s Pingo Doce', 'Rua Feira Hipermercados, 3800-000 Aveiro', 40.6519812362783, -8.620476728835527, 1, 2, 'McDonald1'),
-- ('McDonald''s Universidade', 'Rua das Pombas, 3810-150 Aveiro', 40.63260134516651, -8.649728523856686, 1, 3, 'McDonald2'),
-- ('Burger King Forum', 'Forum Aveiro, 3800-000 Aveiro', 40.638333, -8.653679, 2, 4, 'Burger3'),
-- ('Burger King Glicínias', 'Av. Dr. Lourenço Peixinho, 3800-000 Aveiro', 40.643154, -8.650535, 2, 5, 'Burger4'),
-- ('KFC Centro', 'Rua de Coimbra, 3000-000 Coimbra', 40.205641, -8.419551, 3, 6, 'KFC5')
-- ON CONFLICT (name) DO NOTHING;